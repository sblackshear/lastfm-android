...
import fm.last.boffin.scrobbler.ScrobblerQueueEntry;
...
public class ScrobblerQueueDao extends AbstractDao<ScrobblerQueueEntry>
{
	...
	/*
	 * (non-Javadoc)
	 * @see fm.last.boffin.db.AbstractDao#buildObject(android.database.Cursor)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see fm.last.boffin.db.AbstractDao#getTableName()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see fm.last.boffin.db.AbstractDao#fillContent(android.content.ContentValues, java.lang.Object)
	 */
	@Override
